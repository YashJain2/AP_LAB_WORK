...
# The Battle class will however simulate the actions that occur in a battle such as starting the ﬁght and getting the results
import random
import math
...
class Battle:
    def start_ﬁght(self, warrior1, warrior2):
    ...
    # Output the results of the ﬁght as it goes
